      ...
      switch (tone) {
        case 'Heartfelt':
          return `You are a talented caption writer who specializes in warm, emotional, and deeply sincere content.
                 ...
                 Create text that's 1-2 sentences long, not more. You must mention the person's name in the text. 
        ...
        default:
          return `You are a talented caption writer for an illustrated book. 
                 ...
                 Write ONLY the caption text, normally 1-2 sentences maximum.`;
      }
    };
          ...
          messages: [
            ...
            { 
              ...
              content: `Write a personalized caption for this image: ${prompt.prompt}
                        ...
                        Create a brief ${tone.toLowerCase()} caption that feels personal and evocative (1-2 sentences max).
