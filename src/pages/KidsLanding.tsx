  ...
  return <div className="page-transition">
      <div className="bg-white shadow-lg">
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-amber-300 to-amber-400" />
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="text-white space-y-6">
                  ...
                  <a href="#book-types" className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-amber-300 rounded-full hover:bg-amber-400 transition-colors">
                    Choose My Book
                  </a>
                </div>
        ...
        <div id="book-types" className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group">
              ...
              <Link to="/create/kids/adventure/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-amber-400 bg-white border border-amber-300 rounded-full hover:bg-amber-300 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
            ...
            <div className="group">
              <div className="relative aspect-square bg-white rounded-lg shadow-lg overflow-hidden mb-4">
                <img src="/lovable-uploads/d7889756-42bc-4117-8fdb-9746ee840bfd.png" alt="Career Exploration" className="w-full h-full object-cover" />
              </div>
