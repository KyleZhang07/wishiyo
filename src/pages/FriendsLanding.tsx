        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group">
              ...
              <Link to="/create/friends/funny-biography/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-sky-500 bg-white border border-sky-400 rounded-full hover:bg-sky-400 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
            ...
            <div className="group">
              ...
              <Link to="/create/friends/wild-fantasy/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-sky-500 bg-white border border-sky-400 rounded-full hover:bg-sky-400 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
            ...
            <div className="group">
              ...
              <Link to="/create/friends/prank-book/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-sky-500 bg-white border border-sky-400 rounded-full hover:bg-sky-400 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
          </div>
