  ...
  return <div className="page-transition">
      <div className="bg-white shadow-lg">
        <div className="relative">
          ...
          <div className="relative z-10 px-[60px] bg-sky-100 my-[64px] py-[72px]">
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="text-white space-y-6">
                  <h1 className="text-4xl font-display font-bold px-0 mx-0 md:text-4xl text-slate-800">Express Your Love Story</h1>
                  <p className="text-xl text-slate-800">Create a heartfelt book filled with your special moments and deepest feelings</p>
