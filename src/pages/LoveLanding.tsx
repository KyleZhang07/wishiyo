            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="text-white space-y-6">
                  ...
                  <Link to="/create/love/love-story/character" className="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-red-400 rounded-sm hover:bg-red-500 transition-colors">
                    Create My Book
                  </Link>
                </div>
                <div className="hidden md:block">
                  <div className="w-56 h-56 mx-auto rounded-sm overflow-hidden border-4 border-red-100">
