            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="text-white space-y-6">
                  ...
                  <a href="#book-types" className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-red-300 rounded-full hover:bg-red-400 transition-colors">
                    Choose My Book
                  </a>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group">
              ...
              <Link to="/create/love/love-story/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-red-400 bg-white border border-red-300 rounded-full hover:bg-red-300 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
            ...
            <div className="group">
              ...
              <Link to="/create/love/love-poems/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-red-400 bg-white border border-red-300 rounded-full hover:bg-red-300 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
            ...
            <div className="group">
              ...
              <Link to="/create/love/picture-album/author" className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-red-400 bg-white border border-red-300 rounded-full hover:bg-red-300 hover:text-white transition-colors">
                Start Create
              </Link>
            </div>
          </div>
