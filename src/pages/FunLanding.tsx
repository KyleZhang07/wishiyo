            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="text-white space-y-6">
                  ...
                  <p className="text-xl text-slate-800">Create a fun and memorable book for anyone special</p>
                  <Link to="/create/fun/author" className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-amber-400 rounded-full hover:bg-amber-500 transition-colors">
                    Choose My Book
                  </Link>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group">
              <div className="relative aspect-square bg-white rounded-lg shadow-lg overflow-hidden mb-4">
                <img src="/lovable-uploads/d7889756-42bc-4117-8fdb-9746ee840bfd.png" alt="Fun Stories" className="w-full h-full object-cover" />
              </div>
            ...
            <div className="group">
              ...
              <p className="text-gray-600 mb-2">A whimsical collection of exciting stories</p>
            </div>

            <div className="group">
              <div className="relative aspect-square bg-white rounded-lg shadow-lg overflow-hidden mb-4">
                <img src="/lovable-uploads/d7889756-42bc-4117-8fdb-9746ee840bfd.png" alt="Memory Book" className="w-full h-full object-cover" />
              </div>
              <h3 className="text-xl font-bold mb-2">Memory Book</h3>
              <p className="text-gray-600 mb-2">Capture your fun moments together</p>
            </div>
          </div>
        </div>
      </div>
