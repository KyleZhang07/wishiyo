...
const FunnyBiographyPhotosStep = () => {
  ...
  const handleFileSelect = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      ...
      toast({
        ...
        description: "Your funny photo has been saved"
      });
    };
  ...
  return (
    <WizardStep
      title="Add a Funny Photo"
      description="Upload a photo that captures your humorous side!"
      previousStep="/create/fun/funny-biography/ideas"
      nextStep="/create/fun/funny-biography/generate"
      currentStep={4}
      totalSteps={5}
    >
          ...
          <div className="aspect-square w-full border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center">
            {!photo ? (
              ...
              >
                ...
                <span className="text-gray-500">Click to upload a funny photo</span>
              </Button>
            ) : (
              <button
                ...
                onClick={handleUploadClick}
              >
                <img src={photo} alt="Funny moment" className="w-full h-full object-cover rounded-lg" />
