    ...
    if (savedPrompts && partnerPhoto) {
      ...
      if (prompts && prompts.length > 1) {
        ...
        try {
          ...
          if (error) throw error;
          if (data?.contentImage?.[0]) {
            const { data: expandData, error: expandError } = await supabase.functions.invoke('expand-image', {
              body: { imageUrl: data.contentImage[0] }
            });
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage(expandData.imageData);
              localStorage.setItem('loveStoryContentImage', expandData.imageData);
            }
          }
        } catch (error) {
    ...
    if (savedPrompts && partnerPhoto) {
      ...
      if (prompts && prompts.length > 2) {
        ...
        try {
          ...
          if (data?.contentImage2?.[0]) {
            const { data: expandData, error: expandError } = await supabase.functions.invoke('expand-image', {
              body: { imageUrl: data.contentImage2[0] }
            });
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage2(expandData.imageData);
              localStorage.setItem('loveStoryContentImage2', expandData.imageData);
            }
          }
        } catch (error) {
    ...
    if (savedPrompts && partnerPhoto) {
      ...
      if (prompts && prompts.length > 3) {
        ...
        try {
          ...
          if (contentImage) {
            const { data: expandData, error: expandError } = await supabase.functions.invoke('expand-image', {
              body: { imageUrl: contentImage }
            });
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage3(expandData.imageData);
              localStorage.setItem('loveStoryContentImage3', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 4) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage4(expandData.imageData);
              localStorage.setItem('loveStoryContentImage4', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 5) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage5(expandData.imageData);
              localStorage.setItem('loveStoryContentImage5', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 6) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage6(expandData.imageData);
              localStorage.setItem('loveStoryContentImage6', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 7) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage7(expandData.imageData);
              localStorage.setItem('loveStoryContentImage7', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 8) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage8(expandData.imageData);
              localStorage.setItem('loveStoryContentImage8', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 9) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage9(expandData.imageData);
              localStorage.setItem('loveStoryContentImage9', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 10) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage10(expandData.imageData);
              localStorage.setItem('loveStoryContentImage10', expandData.imageData);
            }
          }
        } catch (error) {
      ...
      if (prompts && prompts.length > 11) {
        ...
        try {
          ...
          if (contentImage) {
            ...
            if (expandError) throw expandError;
            if (expandData?.imageData) {
              setContentImage11(expandData.imageData);
              localStorage.setItem('loveStoryContentImage11', expandData.imageData);
            }
          }
        } catch (error) {
