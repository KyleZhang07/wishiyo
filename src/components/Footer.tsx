      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              ...
              <a href="https://www.instagram.com/wishiyo" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-600 hover:text-[#FF6B35]">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-600">
            © {new Date().getFullYear()} <span className="brand-logo">WISHIYO</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
