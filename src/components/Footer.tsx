        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-5">
              <a href="https://www.tiktok.com/@wishiyo" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-gray-700 hover:text-[#FF6B35] transition-colors">
              ...
              <a href="https://www.instagram.com/wishiyo" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-700 hover:text-[#FF6B35] transition-colors">
