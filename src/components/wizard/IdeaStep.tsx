          ...
          {category === 'love' ? (
            <>
              <div className="flex justify-end">
                <Button 
                  variant="outline" 
                  className="bg-[#F97316] text-white hover:bg-[#F97316]/80"
                  onClick={generateIdeas}
                ...
                <div className="text-center py-20">
                  <div className="flex flex-col items-center justify-center">
                    <div className="relative w-16 h-16 mb-6">
                      <div className="absolute top-0 left-0 w-16 h-16 rounded-full border-4 border-t-transparent border-[#F97316] animate-spin"></div>
                      <div className="absolute top-0 left-0 w-16 h-16 rounded-full border-4 border-r-transparent border-b-transparent border-l-transparent border-[#F97316]/20"></div>
                    </div>
                    <h3 className="text-xl font-medium text-[#F97316]">
                      Creating book ideas
                    </h3>
                  </div>
                </div>
                    ...
                    <div 
                      ...
                      className={`${category === 'friends' ? 'bg-white rounded-lg p-5' : ''} cursor-pointer transition-all hover:shadow-md ${
                        selectedIdeaIndex === index 
                          ? 'ring-2 ring-[#F97316] shadow-lg scale-[1.02]' 
                          : ''
                      }`}
