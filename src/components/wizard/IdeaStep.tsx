...
const IdeaStep = ({
  ...
  return <WizardStep title="Let's pick a book idea" description="Choose from these AI-generated book ideas or regenerate for more options." previousStep={previousStep} currentStep={3} totalSteps={4} nextStep={nextStep}>
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          {ideas.map((idea, index) => <div key={index} className="bg-white rounded-lg p-6 cursor-pointer hover:shadow-md transition-shadow">
