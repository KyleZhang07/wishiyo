      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {user ? (
              ...
              <Link 
                to="/login" 
                className="rounded-lg bg-primary text-white hover:bg-primary/90 transition-colors p-2"
              >
        ...
        {isMenuOpen && (
          <nav className="md:hidden py-4 space-y-4">
            <Link 
              to="/fun" 
              className="block px-4 py-2 text-amber-600 hover:text-amber-700 transition-colors"
